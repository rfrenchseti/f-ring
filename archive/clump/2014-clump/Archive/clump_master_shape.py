...
#        plt.show()
    ...
    plt.plot(seed_int, lw = 3.0, color='red', alpha = 0.6)
...
clump_avg_arr = fit_seed_clump(clump_list)

pickle.dump(clump_avg_arr, master_clump_fp)
master_clump_fp.close()
#plt.show()
