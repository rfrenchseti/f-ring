...
for pd_index, row in data_pd.iterrows():
    ...
    full_corot_data = np.degrees(f_ring.fring_inertial_to_corotating(
    ...
    if arguments.compare_ew:
        ...
        for suffix in ('before', 'after'):
            ...
            mosaic_inertial_long = np.degrees(f_ring.fring_corotating_to_inertial(
