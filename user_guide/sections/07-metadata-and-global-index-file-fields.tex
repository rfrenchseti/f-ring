...
\hline
\code{core\_\allowbreak{}radius} & The radius of the ideal F ring core from the orbit model at this corotating longitude (constant for one image) \\
\hline
...
\hline
\code{corotating\_\allowbreak{}longitude\_\allowbreak{}prometheus} & The longitude of Prometheus at the time of the source observation in the same frame of reference used for the F ring core (constant for one image) \\
\hline
...
\hline
\code{corotating\_\allowbreak{}longitude\_\allowbreak{}pandora} & The longitude of Pandora at the time of the source observation in the same frame of reference used for the F ring core (constant for one image) \\
\hline
...
\hline
\code{file\_\allowbreak{}spec} & The path to the reprojected image label file relative to the bundle root, \textit{e.g. }\code{data\_\allowbreak{}reproj\_\allowbreak{}img/\allowbreak{}iosic\_\allowbreak{}276rb\_\allowbreak{}complitb4001\_\allowbreak{}si/\allowbreak{}}\newline \code{1874525875w\_\allowbreak{}reproj\_\allowbreak{}img.\allowbreak{}lblx} \\
\hline
...
\hline
\code{percent\_\allowbreak{}coverage} & The percentage of 360° containing valid data; computed from num\_\allowbreak{}valid\_\allowbreak{}longitudes / 18000 * 100 \\
\hline
...
\hline
\code{rings:\allowbreak{}maximum\_\allowbreak{}corotating\_\allowbreak{}ring\_\allowbreak{}longitude} & The maximum corotating longitude, representing the right edge of the reprojected image; note that it’s possible for min > max, in which case the corotating range wraps around at 360° \\
\hline
...
\hline
\code{rings:\allowbreak{}maximum\_\allowbreak{}inertial\_\allowbreak{}ring\_\allowbreak{}longitude} & The maximum inertial longitude from the source image used to create the reprojected image; because this is a single exposure, the distance between the min and max corotating longitude and min and max inertial longitude will be identical \\
\hline
...
\hline
\code{rings:\allowbreak{}mean\_\allowbreak{}incidence\_\allowbreak{}angle} & The ring plane incidence angle at the time of the observation; incidence angle does not vary with longitude so minimum and maximum versions are not supplied \\
\hline
...
\hline
\code{nav\_\allowbreak{}quality} & The quality of the navigation used for this reprojected image as taken from the mosaic that uses it – this is not a true representation of the navigation quality of this one image, just the overall quality of images in this group and all reprojected images for the same mosaic will have the same indicated quality; values are G=Good, F=Fair, P=Poor (Section \ref{sec:navigation}) \\
\hline
\code{notes} & Notes about the mosaic that uses this reprojected image (Section \ref{sec:the-global-index-files}) \\
\hline
\end{longtable}
\endgroup


\subsection{Mosaic global index}
\label{sec:mosaic-global-index}

\begingroup\small
\begin{longtable}{|>{\raggedright\arraybackslash}p{0.313\linewidth}|>{\raggedright\arraybackslash}p{0.607\linewidth}|}
\hline
\code{pds:\allowbreak{}logical\_\allowbreak{}identifier} & The PDS4 logical identifier, \textit{e.g.} \code{urn:\allowbreak{}nasa:\allowbreak{}pds:\allowbreak{}cassini\_\allowbreak{}iss\_\allowbreak{}fring\_\allowbreak{}mosaics\_\allowbreak{}rsfrench2025:\allowbreak{}data\_\allowbreak{}mosaic:\allowbreak{}iosic\_\allowbreak{}276rb\_\allowbreak{}complitb4001\_\allowbreak{}si\_\allowbreak{}mosaic} \\
\hline
\code{cassini:\allowbreak{}observation\_\allowbreak{}id} & The Cassini observation name of the source image, \textit{e.g. }\code{IOSIC\_\allowbreak{}276RB\_\allowbreak{}COMPLITB3001\_\allowbreak{}SI} \\
\hline
...
\hline
\code{rings:\allowbreak{}maximum\_\allowbreak{}corotating\_\allowbreak{}ring\_\allowbreak{}longitude} & The maximum corotating longitude, representing the right edge of the mosaic; note that it’s possible for min > max, in which case the corotating range wraps around at 360° \\
\hline
...
\code{rings:\allowbreak{}maximum\_\allowbreak{}phase\_\allowbreak{}angle} & The maximum (across all valid longitudes) phase angle \\
\hline
\code{rings:\allowbreak{}mean\_\allowbreak{}incidence\_\allowbreak{}angle} & The ring plane incidence angle at the time of the observation; since incidence angle changes slowly over time only a single value is provided \\
\hline
\code{rings:\allowbreak{}mean\_\allowbreak{}emission\_\allowbreak{}angle} & The mean (across all valid longitudes) emission angle; the angle is < 90° on the lit side of the rings \\
\hline
\code{rings:\allowbreak{}minimum\_\allowbreak{}emission\_\allowbreak{}angle} & The minimum (across all valid longitudes) emission angle \\
...
\hline
\code{bkgnd\_\allowbreak{}lower\_\allowbreak{}limit} & (Background-subtracted mosaic only) The lower ring delta radius used to delineate the background region; radii between this and core-1000 are used for background modeling. \\
\hline
\code{bkgnd\_\allowbreak{}upper\_\allowbreak{}limit} & (Background-subtracted mosaic only) The upper ring delta radius used to delineate the background region; radii between this and core+1000 are used for background modeling. \\
\hline
\end{longtable}
\endgroup
