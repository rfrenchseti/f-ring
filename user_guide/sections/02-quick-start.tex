...
\hline
 & \code{IMGID\_\allowbreak{}reproj\_\allowbreak{}img.\allowbreak{}img} & Binary file containing an \textit{N}×401 array of 32-bit floating point values calibrated as I/F. The array represents a grid of corotating longitude in 0.02° increments (\textit{x}) and radius in increments of 5 km (\textit{y}). The longitudes are restricted to the range containing valid data. \\
\hline
...
\hline
 & \code{OBSID\_\allowbreak{}mosaic[\_\allowbreak{}bkg\_\allowbreak{}sub].\allowbreak{}img} & Binary file containing an 18000×401 array of 32-bit floating point values calibrated as I/F. The array represents a grid of corotating longitude in 0.02° increments (\textit{x}) and radius in increments of 5 km (\textit{y}). \\
\hline
...
\hline
 & \code{OBSID\_\allowbreak{}mosaic[\_\allowbreak{}bkg\_\allowbreak{}sub]\_\allowbreak{}metadata\_\allowbreak{}src\_\allowbreak{}imgs.\allowbreak{}tab} & Fixed-width comma-delimited table containing a map of image numbers from the \code{metadata\_\allowbreak{}params} table to the associated reprojected image name. \\
\hline
\end{longtable}
\endgroup

Other collections are provided in the bundle, including a document collection containing this User Guide and a miscellaneous bundle containing global index files. All collections and support files are described in the sections below.

The remainder of this User Guide provides detailed guidance on the use of the bundle:
